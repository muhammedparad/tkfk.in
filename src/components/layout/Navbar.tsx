    ...
    <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-gray-100 shadow-sm transition-all">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-14 sm:h-16 md:h-20">
          ...
          <Link href="/" className="flex items-center gap-2.5 sm:gap-3.5 group focus-visible:ring-2 focus-visible:ring-emerald-600 rounded-xl p-0.5">
            <div className="relative w-9 h-9 sm:w-10 sm:h-10 flex-shrink-0 bg-white rounded-xl shadow-xs border border-slate-200/80 p-1 flex items-center justify-center overflow-hidden transition-transform group-hover:scale-105">
              <svg viewBox="0 0 24 24" className="w-5 h-5 text-slate-700" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="flex flex-col">
              <div className="flex items-center gap-1">
                <span className="font-extrabold text-base sm:text-lg text-slate-900 tracking-tight">TKFK <span className="text-[#00966b]">2026</span></span>
              </div>
          ...
          <div className="flex md:hidden items-center gap-2">
            ...
            <button
              ...
              className="w-10 h-10 rounded-full text-white bg-[#00966b] hover:bg-[#00835d] transition-all shadow-sm flex items-center justify-center active:scale-95 focus-visible:ring-2 focus-visible:ring-emerald-600 focus-visible:ring-offset-2"
